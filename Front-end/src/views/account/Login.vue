  ...
  <v-container style="width: 63rem;">
    <v-row>
      ...
      <v-col cols="10" sm="8" md="6" lg="5">
        <v-form>
          <div class="mt-10" style="font-size: 3rem; font-weight: bold">
            Tada! Easter Egg!
          </div>
          <v-text-field
            outlined
        ...
        <div>
          <span class="text-caption"
            >ID는 (서비스이름)에 로그인할 때 사용하는 이메일 주소입니다.</span
          >
        </div>
        <div>
          <v-btn color="teal" x-large class="my-5 white--text" block
            >로그인</v-btn
          >
        </div>
      ...
      <img
        src="https://i.stack.imgur.com/SBv4T.gif"
        alt="대신 귀여운 야돈을 드리겠습니다"
        width="500"
      />
