    ...
    <v-row class="justify-center" style="background-color:rgb(245, 245, 247, 0.7)">
      <v-btn-toggle v-model="toggle_exclusive" mandatory>
        <v-col class="text-center" v-for="(clss, i) in classList" :key="clss.name" style="background-color:rgb(245, 245, 247, 0.7)">
          <v-btn active-class="no-active" text @click="now=i" style="outline:none">
            <v-img v-if="now==i" height="50px" width="50px" :src="clss.imgPath2"></v-img>
            <v-img v-else height="50px" width="50px" :src="clss.imgPath"></v-img>
          </v-btn>
          <div v-if="now==i" style="color:rgb(0, 112, 201)" class="text-caption">{{ clss.name }}</div>
    ...
    <v-container style="width: 63rem;" class="mt-2">
      ...
      >
        <v-container class="mt-5">
          <v-window v-model="now" class="elevation-1">
            <v-window-item v-for="n in length" :key="n">
              ...
              >
                <v-list-item>
                  <v-list-item-content>
                    <v-list-item-title class="headline">{{ classList[n - 1].name }}</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
                <iframe
                  width="100%"
                  height="500"
                  :src="classList[n - 1].videoUrl"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
                ></iframe>

                <v-card-text>{{ classList[n - 1].description }}</v-card-text>
    ...
    return {
      classList: [
        ...
        },
        {
          ...
          description: "태극 1장은 팔괘의 건(乾)을 의미하며 건은 하늘과 양을 뜻한다. \
        ...
        },
        {
          ...
          description: "태극 2장은 팔괘의 태(兌)를 의미하며 태는 속으로는 단단하고 겉으로는 부드럽다는 뜻이다. \
        ...
        },
        {
          ...
          description: "태극 3장은 팔괘의 이(離)를 의미하며 이는 불을 나타내고 뜨겁고 밝음을 지닌다. \
        ...
        },
        {
          ...
          description: "태극 4장은 팔괘의 진(震)을 의미하며 진은 우뢰를 나타내고 큰 힘과 위엄있는 듯을 지니고 있다. \
        ...
        },
        {
          ...
          description: "태극 5장은 팔괘의 손(巽)을 의미하며 손은 바람을 나타내며 바람의 강약에 따라 위세와 고요의 뜻을 지닌다. \
        ...
        },
        {
          ...
          description: "태극 6장은 팔괘의 감(坎)을 의미하며 감은 물을 나타내고 끊임없는 흐름과 유연함을 뜻한다. \
        ...
        },
        {
          ...
          description: "태극 7장은 팔괘의 간(艮)을 의미하며 산을 나타내고 육주함과 굳건하다는 뜻을 지닌다. \
        ...
        },
        {
          ...
          description: "태극 8장은 팔괘의 곤(坤)을 의미하며 곤은 음과 땅을 나타내고 뿌리와 안정 그리고 시작과 끝의 뜻을 지닌다. \
        ...
        },
        {
          ...
          description: "1품/단이 수련하는 품새. 품새선은 '선비 사'자(士)이다. 유단자가 되어 처음 배우는 품새이지만, 굉장히 어렵다. 오히려 2품의 품새인 금강이 수련 난이도는 더 쉬울 정도이다."
        },
        {
          id: 11,
          name: "금강",
          ...
          description: "2품/단 이 수련하는 품새. 품새선은 '뫼 산'자(山)이다. 불교의 수호신으로써 인왕역사라 불리우는 금강역사에서 따 왔다. 의미는 단단하고 굳건함. 그에 걸맞게 육중하고 무게감이 있다."
        },
        {
          id: 12,
          name: "태백",
          ...
          description: "3품/단 이 수련하는 품새. 품새선은 '장인 공'자(工)이다. \
